...
<div class="container">
	<form class="form-horizontal" action="updatePostPro" method="post">
		<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center border-bottom m-3">
			<strong>제목</strong> <input class="form-control" name= "subject" value="${article.subject}" placeholder="title">
			<input type="hidden" class="form-control" name="board_num" value="${article.board_num}">
			<input type="hidden" class="form-control" name="posts_num" value="${article.posts_num}">
		...
		<div class="form-group">
			<div class="col-sm-offset-2 col-sm-10">
		 		<button type="button" class="btn btn-light" onclick="window.location='../board/viewPost?post_num=${article.posts_num}'">이전</button>
		        <button type="submit" class="btn btn-warning" onclick="contentDB()">수정</button>
